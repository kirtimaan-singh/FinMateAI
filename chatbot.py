...
# CHANGED: Explicitly forces the sidebar to stay open and sets the light base theme defaults globally
st.set_page_config(
...
st.markdown("""
    ...
    /* Forces the sidebar to stand up correctly in the container */
...
# Top Navbar Render using computed variables
st.markdown(f"""
