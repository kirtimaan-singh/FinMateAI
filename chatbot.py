...
# 1. Page Configuration (Sidebar ko locked aur open rakhne ke liye)
st.set_page_config(
...
current_day_str = now.strftime("%A, %d %B %Y")  # Example: Monday, 22 June 2026
current_time_str = now.strftime("%I:%M %p")     # Example: 10:45 PM
...
# 3. 🎨 Custom CSS Stylesheet Injection (Groww, Zerodha & INDmoney Premium Theme)
st.markdown("""
    <style>
    /* Global Background and Times New Roman Serif Typography */
    ...
    /* Hiding platform defaults */
    #MainMenu {visibility: hidden;}
    footer {visibility: hidden;}
    header {visibility: hidden;}
    div[data-testid="stDeployButton"] {display: none;}
    
    /* Dark Green Premium Sidebar Layout */
    ...
    /* Metric Cards Grid Layout Style */
...
# 4. Top Corporate Header Injector
st.markdown(f"""
